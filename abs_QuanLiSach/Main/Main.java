...
public class Main {
	...
	public static void main(String[] args) {
		...
		Inventory.addBook(new VanHoc("Tá»‘ Há»¯u", 100, 5, "ThÆ¡", 10));
		Inventory.addBook(new KhoaHoc("A", 50, 1, "Tá»± nhiĂªn", 2018));
		Inventory.addBook(new KhoaHoc("B", 70, 7, "ToĂ¡n Há»�c", 2019));
		Inventory.addBook(new NgoaiVan("C", 50, 15, "Anh", "ISBN 0-306-40615-3"));
		Inventory.addBook(new NgoaiVan("D", 30, 10, "Ä�á»©c", "ISBN 0-306-40615-2"));
